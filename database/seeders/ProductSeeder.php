...
class ProductSeeder extends Seeder
{
    ...
    public function run()
    {
        $corporation = Corporation::firstOrCreate(
            ['name' => 'Ethical Foods Inc.'],
            ['slug' => 'ethical-foods', 'description' => 'A company committed to ethical food production.']
        );
        ...
        $products = [
            ...
            [
                ...
                'description' => 'Rich dark chocolate made from fair trade cocoa.', 'barcode' => '1234567890124',
            ],
            [
